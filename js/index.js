...
hexo.extend.filter.register('after_render:html', function (locals) {
  ...
  if (post.length > 0 || tag.length > 0 || category.length > 0 || calendar.length > 0 || radar.length > 0) {
        ...
        $('head').after('<style type="text/css">#posts-chart,#posts-calendar,#categories-chart,#categories-radar,#tags-chart{max-width:760px;width:100%;height: 300px;margin: 0px;padding: 0px;display: flex;}</style><script type="text/javascript" data-pjax="" src="https://cdn.jsdelivr.net/npm/echarts@4.7.0/dist/echarts.min.js"></script>')
...
function postsChart () {
  ...
  return `
  <footer data-pjax id="postsChart">
    var color = '#6e7f98';
...
function categoriesChart () {
  ...
  return `
  <script data-pjax id="categoriesChart">
    var color = '#6e7f98';
    var color = document.documentElement.getAttribute('data-theme') === 'light' ? '#4c4948' : '#afb8c5';
...
function categoriesRadar () {
  ...
  return `
  <script data-pjax id="categoriesRadar">
    var color = '#6e7f98';
    var color = document.documentElement.getAttribute('data-theme') === 'light' ? '#4c4948' : '#afb8c5';
